...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(110, 160, 371, 251))
    ...
    def Excel(self):
        ...
        QMessageBox.warning(self.centralwidget,'완료','엑셀완료')
    ...
    def assacom(self):    
        ...
        QMessageBox.warning(self.centralwidget,'완료','아싸컴완료')
    ...
    def blueit(self):
        ...
        QMessageBox.warning(self.centralwidget,'완료','블루아이티완료')
        return True
    ...
    def ohmypc(self):
        ...
        QMessageBox.warning(self.centralwidget,'완료','오마이피씨완료')
        return True
    ...
    def comzip(self):
        ...
        for link in url:
            ...
            for info in soup.select('td:nth-child(2) > table > tbody > tr:nth-child(10) > td > table > tbody > tr > td:nth-child(2)'):
                ws.Cells(i,j).Value=info.text.strip()
                j+=1
                if '계좌이체(현금)' in info.text.strip():
                    i+=1
                    j=3
            cnt=0
        
        QMessageBox.warning(self.centralwidget,'완료','컴집완료')
        return True
    ...
    def popconpc(self):
        ...
        QMessageBox.warning(self.centralwidget,'완료','팝콘피씨완료')
        return True
    ...
    def commawang(self):
        ...
        QMessageBox.warning(self.centralwidget,'완료','컴마왕완료')
        return True
