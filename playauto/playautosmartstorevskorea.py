...
while(1):
    ...
    try:
        ...
        time.sleep(2)
        driver.find_element_by_xpath('//*[@id="sidebar-tabs-5"]/div/div[1]/div/treecontrol/ul/li[6]/treeitem/ul/li[2]/treeitem/ul/li[1]/div').click()
        time.sleep(2)
    ...
    for j in soup.select('div > ul.a-content-nav-tabs > li > a > span'):
        print(j.string)
        if int(j.string)>0:
            print("남아있다")
